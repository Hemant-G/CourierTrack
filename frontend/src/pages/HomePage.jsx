...
const HomePage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-120px)] flex flex-col items-center justify-center bg-slate-900 text-white bg-cover bg-center relative" style={{ backgroundImage: `url(${heroImageUrl})` }}>
